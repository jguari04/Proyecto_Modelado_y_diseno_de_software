...
Se apoya en:
- registrar_usuario
- confirmar_cuenta (aquí se simula confirmación automática)
- login
"""
...
class AuthApp(tk.Tk):
    ...
    def on_login_exitoso(self, usuario):
        """
        Aquí podrías decidir a qué panel enviar según el rol.
        De momento solo mostramos un mensaje y cerramos la app.
        """
        messagebox.showinfo(
            "Login OK",
            f"Usuario autenticado:\n{usuario.email}\n\n"
            "A partir de aquí podrías abrir el panel principal de Finanza."
        )
        self.destroy()
